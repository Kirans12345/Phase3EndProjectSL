...
public class RestAssured002 {
	...
	Logger logger = LogManager.getLogger(RestAssured002.class);

	@Test(priority = '1')
	public void assignment002Post() {
		logger.info("Course End project - Assignment002 - POST request");
		File file = new File(
				"J:\\MPHASIS\\Phase3\\RestAPI Assured\\Phase3_RestAssured\\src\\main\\resources\\data.json");
	...
	public void assignment002Put() {
		File file = new File(
				"J:\\MPHASIS\\Phase3\\RestAPI Assured\\Phase3_RestAssured\\src\\main\\resources\\dataput.json");
		int id = RestAssured.given().baseUri("https://petstore.swagger.io/v2/pet/").contentType(ContentType.JSON)
